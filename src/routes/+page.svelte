...
>
	<h1 class="not-prose text-2xl font-medium text-stone-950">I'm Hunter, aka Huntabyte.</h1>
	<p>
	...
	<ul>
		...
		<li>
			<a href="https://melt-ui.com" target="_blank"> Melt UI </a>
		</li>
		<li>
			<a href="https://bits-ui.com" target="_blank"> Bits UI </a>
		</li>
		<li>
			<a href="https://formsnap.dev" target="_blank"> Formsnap </a>
		</li>
		<li>
	...
	<p>
		I also gain fulfillment in sharing what I learn with others, mostly in the form of <a
